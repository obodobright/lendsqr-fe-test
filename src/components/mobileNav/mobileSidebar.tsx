        ...
        <aside className={styles.sidebarWrapper}>
            <aside className={styles.sidebarContainer}>
                <div className={styles.logoWrapper}>
                    <MdClose onClick={hideSidebar} className={styles.fatimes} fontSize={25} color="#39CDCC" cursor="pointer" />
                    <Logo />
                </div>
                        ...
                        <li key={navIndex}>
                            ...
                            <section>{nav.children?.map((navChild, navChildIndex) => (
                                <section className={styles.navLink} key={navChildIndex}>
                                    ...
                                    <Link onClick={hideSidebar} href={navChild.link}>{navChild.navTitle}</Link>
                                </section>
                            ))}</section>
                        </li>
                    ))}
