...
export const Pagination = ({ perPage, setCurrPage, currPage, totalPage }: IPaginateProps) => {
    ...
    return (
        <section className={styles.paginateContainer}>
            ...
            <div className={styles.rightWrapper}>
                <button className={styles.Icon} onClick={() => setCurrPage(currPage - 1)} >
                    <svg onClick={() => setCurrPage(currPage - 1)} xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <g opacity="0.6">
                ...
                <ul>
                    {pages.map((el, elIndex) => (
                        <li onClick={() => setCurrPage(el)} key={elIndex}>{el}</li>
                    ))}


                </ul>
                <button onClick={() => setCurrPage(currPage + 1)} className={styles.Icon}>
